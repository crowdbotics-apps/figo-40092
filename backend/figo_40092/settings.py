"""
Django settings for figo_40092 project.
...
WSGI_APPLICATION = 'figo_40092.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "figo_40092 API",
    "DESCRIPTION": "API documentation for figo_40092 App",
    "VERSION": "v1",
}
